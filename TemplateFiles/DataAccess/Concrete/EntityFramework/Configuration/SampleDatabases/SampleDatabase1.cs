...
namespace $safeprojectname$.Concrete.EntityFramework.Configuration.SampleDatabases
{
    class SampleDatabase1 : DropCreateDatabaseIfModelChanges<DatabaseContext>
    {
